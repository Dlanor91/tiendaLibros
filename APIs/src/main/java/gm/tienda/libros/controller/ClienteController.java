...
public class ClienteController {
    ...
    @PostMapping()
    public ResponseEntity<Cliente> post(@RequestBody @Valid Cliente cliente){
    ...
    @PutMapping("{id}")
    public ResponseEntity<Cliente> put(@PathVariable Integer id, @RequestBody @Valid Cliente cliente){

...
public class VentaController {
    ...
    @GetMapping("/{codigo}")
    public ResponseEntity<Venta> getByCodigo(@PathVariable String codigo){
    ...
    @PostMapping("")
    public ResponseEntity<Venta> post(@RequestBody @Valid Venta venta){
    ...
    @PutMapping("/{codigo}")
    public ResponseEntity<Venta> put(@PathVariable String codigo, @RequestBody @Valid Venta venta){
    ...
    public ResponseEntity<Venta> delete(@PathVariable String codigo){
